...
export default function LaptopInterface() {
  ...
  return (
    ...
    className="w-full max-w-[700px] aspect-[16/10] bg-white rounded-xl shadow-xl overflow-hidden border-8 border-gray-800 relative"
  >
    {/* Laptop Top Bar */}
    ...
    <div className="p-4 bg-gray-100 h-[calc(100%-20px)] flex">
      ...
      <div className="flex-grow relative bg-gray-900 rounded-lg overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-900 flex items-center justify-center"
        >
          <Image src="/ambuj.jpg" alt="candidate" width={500} height={500} className="w-full h-full object-cover" />
        </motion.div>
        ...
        >
          ...
          <span className="text-white text-xs opacity-50">3</span>
        </motion.div>
        ...
        >
          <motion.div 
            ...
            className={`w-3 h-3 rounded-full ${isLive ? 'bg-red-500' : 'bg-red-500'}`} 
          />
