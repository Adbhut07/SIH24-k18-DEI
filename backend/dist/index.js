...
(() => __awaiter(void 0, void 0, void 0, function* () {
    yield (0, mediasoupServer_1.createMediasoupWorker)(); // Ensure Mediasoup worker is initialized
}))();
io.on('connection', (socket) => {
    ...
    socket.on('consume', (_a, callback_1) => __awaiter(void 0, [_a, callback_1], void 0, function* ({ producerId, rtpCapabilities }, callback) {
        const router = (0, mediasoupServer_1.getRouter)();
